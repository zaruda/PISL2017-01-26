package by.it.group473601.kalashynski.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (char key : count.keySet()) {
            Node node = new LeafNode(count.get(key)/*частота*/, key/*значение*/);
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group473601/kalashynski/lesson03/dataHuffman.txt");
